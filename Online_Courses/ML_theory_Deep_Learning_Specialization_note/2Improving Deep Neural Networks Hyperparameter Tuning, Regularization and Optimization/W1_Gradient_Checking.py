...
def gradient_check(x, theta, epsilon=1e-7, print_msg=False):
    ...
    J_plus =               forward_propagation(x,theta+epsilon)                     # Step 3
    J_minus =           forward_propagation(x,theta-epsilon)                        # Step 4
    ...
    # difference =                                # Step 3'
    # YOUR CODE STARTS HERE
    numerator =        abs(gradapprox-grad)                         # Step 1'
    denominator =         abs(gradapprox)+abs(grad)                      # Step 2'
...
def gradient_check_n(parameters, gradients, X, Y, epsilon=1e-7, print_msg=False):
    ...
    for i in range(num_parameters):
        ...
        J_plus_TEMP, _ =        forward_propagation_n(X, Y, vector_to_dictionary(theta_plus))         
        J_plus[i]=J_plus_TEMP
        # YOUR CODE ENDS HERE
        ...
        J_minus_TEMP, _ =        forward_propagation_n(X, Y, vector_to_dictionary(theta_minus))  # Step 3
        J_minus[i]=J_minus_TEMP
        # YOUR CODE ENDS HERE
