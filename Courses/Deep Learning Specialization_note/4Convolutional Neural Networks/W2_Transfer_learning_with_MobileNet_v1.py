...
def data_augmenter():
    ...
    data_augmentation.add(tf.keras.layers.experimental.preprocessing.RandomFlip(mode='horizontal'))
...
optimizer = tf.keras.optimizers.Adam(learning_rate=0.1 * base_learning_rate,name='Adam')
